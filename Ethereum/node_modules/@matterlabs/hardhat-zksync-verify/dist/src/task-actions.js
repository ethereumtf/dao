...
exports.checkVerificationStatus = exports.getContractInfo = exports.verifyContract = exports.getConstructorArguments = exports.getCompilerVersions = exports.verify = void 0;
...
async function verifyContract({ address, contract: contractFQN, constructorArguments, libraries }, hre, runSuper) {
    ...
    if (minimumBuildContractBytecode === matchedBytecode) {
        ...
        request.sourceCode = (0, plugin_1.getSolidityStandardJsonInput)(hre, dependencyGraph.getResolvedFiles());
    }
    else {
